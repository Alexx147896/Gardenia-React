...
export default function ReturnsPolicy() {
  return (
    ...
    <div className={styles.text_container}> 
        <p className={styles.text}>Thank you for your purchase. We hope you are happy with your purchase. However, if you are in anyway disappointed with our flowers or service, please call us on +34 01623 750343 (Spain) or +34 1623 750343 (International), or email us at gardenia@gmail.com.</p>
